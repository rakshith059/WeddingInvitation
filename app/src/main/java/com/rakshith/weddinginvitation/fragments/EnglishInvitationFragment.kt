...
class EnglishInvitationFragment(override var posX: Int?, override var posY: Int?) : BaseFragment(), ExitWithAnimation {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        fragment_invitation_tv_name?.text = resources.getString(R.string.name)
        fragment_invitation_tv_rakshith_parent_name?.text = resources.getString(R.string.parent_name)
        fragment_invitation_tv_when?.text = resources.getString(R.string.`when`)
